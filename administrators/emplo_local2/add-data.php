...
{		
		...
		$ek = $_POST["ekata$i"];
		$ec = $_POST["ecity$i"];		
		$sql="INSERT INTO employees2(emplo2_name,emplo2_pwd,emplo2_kata,emplo2_city) VALUES('".$en."','".$ep."','".$ek."','".$ec."')";
...
<div class="container">
	...
	<th>Πόλη</th>
		...
		<td><input type="text" name="ekata<?php echo $i; ?>" placeholder="κατάστημα" class='form-control' /></td>
		<td><input type="text" name="ecity<?php echo $i; ?>" placeholder="πόλη" class='form-control' /></td>
        
    <tr>
    <td colspan="5">    
    <button type="submit" name="save_mul" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> &nbsp; Εισαγωγή του Υπαλλήλου</button><!--savemul το ονομα του button με το οποιο χρησ σε αλλα σημεια--> 
