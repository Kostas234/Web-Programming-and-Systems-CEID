       ...
       <nav>
        ...
        <div class="nav-login">
          <form action="login.inc.php" method="POST">
              <input type="text" name="emplo3_name" placeholder="username">
              <input type="text" name="emplo3_pwd" placeholder="password">
              <input type="text" name="emplo3_hub" placeholder="σταθμός εργασίας">
